...
export function SignInButton() {
  return (
    <form action={signInWithGoogle}>
      <button
        type="submit"
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-line bg-white px-5 py-3 text-sm font-semibold text-ink shadow-sm transition-colors hover:bg-hover"
      >
