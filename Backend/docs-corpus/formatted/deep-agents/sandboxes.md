...
LangSmith traces show which shell commands ran inside a sandbox and how the agent used filesystem tools. Follow the observability quickstart to get set up. For managed sandbox hosting, see LangSmith Sandboxes.
