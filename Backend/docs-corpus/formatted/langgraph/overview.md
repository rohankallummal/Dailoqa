...
Read Frameworks, runtimes, and harnesses for a comparison of the open source stack.
...
Use LangSmith to trace requests, debug agent behavior, and evaluate outputs. Set `LANGSMITH_TRACING=true` and your API key to get started. Follow the tracing quickstart to get set up.  We recommend you also set up LangSmith Engine which monitors your traces, detects issues, and proposes fixes.
