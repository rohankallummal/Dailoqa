...
product: deepagents
resource: /docs/deepagents/skills
source: /oss/deepagents/skills
tags:
  - deepagents
  - skills
timestamp: 2026-08-13T16:33:15Z
code_examples:
  - ../code/deepagents/skills-create-agent.py
  - ../code/deepagents/skills-create-agent.ts
  - ../code/deepagents/skills-invoke.py
  - ../code/deepagents/skills-invoke.ts
  - ../code/deepagents/skills-usage-state.py
  - ../code/deepagents/skills-usage-store.py
  - ../code/deepagents/skills-usage-filesystem.py
  - ../code/deepagents/skills-usage-state.ts
  - ../code/deepagents/skills-usage-store.ts
  - ../code/deepagents/skills-usage-filesystem.ts
  - ../code/deepagents/skills-dynamic-lists.py
  - ../code/deepagents/skills-dynamic-lists.ts
  - ../code/deepagents/skills-namespaced.py
  - ../code/deepagents/skills-namespaced.ts
  - ../code/deepagents/skills-subagents.py
  - ../code/deepagents/skills-subagents.ts
  - ../code/deepagents/backend-readonly-skills.py
  - ../code/deepagents/backend-readonly-skills.ts
  - ../code/deepagents/skills-approval.py
  - ../code/deepagents/skills-approval.ts
  - ../code/deepagents/skills-personal-writable.py
  - ../code/deepagents/skills-personal-writable.ts
  - ../code/deepagents/skills-sandbox.py
  - ../code/deepagents/skills-sandbox.ts
---
...
**Python**
Code example: [`code/deepagents/skills-create-agent.py`](../code/deepagents/skills-create-agent.py)
...
**JavaScript / TypeScript**
Code example: [`code/deepagents/skills-create-agent.ts`](../code/deepagents/skills-create-agent.ts)
...
**Python**
Code example: [`code/deepagents/skills-invoke.py`](../code/deepagents/skills-invoke.py)
...
**JavaScript / TypeScript**
Code example: [`code/deepagents/skills-invoke.ts`](../code/deepagents/skills-invoke.ts)
...
_Figure: How skill components map into agent context at startup and activation_

As the agent works through a task, it loads skill information in layers:

_Figure: How skills load in layers from metadata to instructions to resources_
...
The Agent Skills specification includes guidance on structuring skills for reliable discovery and activation. The following recommendations build on that foundation with practical patterns for Deep Agents.
...
**Tip**
    Use the `skills-ref` validation tool to check that your `SKILL.md` [frontmatter](#frontmatter-fields) follows the Agent Skills specification naming and format conventions.
...
**StateBackend**
    Code example: [`code/deepagents/skills-usage-state.py`](../code/deepagents/skills-usage-state.py)
...
**StoreBackend**
    Code example: [`code/deepagents/skills-usage-store.py`](../code/deepagents/skills-usage-store.py)
...
**FilesystemBackend**
    Code example: [`code/deepagents/skills-usage-filesystem.py`](../code/deepagents/skills-usage-filesystem.py)
...
**StateBackend**
Code example: [`code/deepagents/skills-usage-state.ts`](../code/deepagents/skills-usage-state.ts)
...
**StoreBackend**
Code example: [`code/deepagents/skills-usage-store.ts`](../code/deepagents/skills-usage-store.ts)
...
**FilesystemBackend**
Code example: [`code/deepagents/skills-usage-filesystem.ts`](../code/deepagents/skills-usage-filesystem.ts)
...
**Python**
Code example: [`code/deepagents/skills-dynamic-lists.py`](../code/deepagents/skills-dynamic-lists.py)
...
**JavaScript / TypeScript**
Code example: [`code/deepagents/skills-dynamic-lists.ts`](../code/deepagents/skills-dynamic-lists.ts)
...
**Note**
    ...
    For CLI storage conventions, see App data.
...
**Python**
Code example: [`code/deepagents/skills-namespaced.py`](../code/deepagents/skills-namespaced.py)
...
**JavaScript / TypeScript**
Code example: [`code/deepagents/skills-namespaced.ts`](../code/deepagents/skills-namespaced.ts)
...
When you use [subagents](../deepagents/subagents.md), you can configure which skills each type has access to:
...
For more information on subagent configuration and skills inheritance, see [Subagents](../deepagents/subagents.md).

## Skill permissions

Production deployments usually need to control three things: which skills each user can see, whether the agent can modify skill files, and whether writes require human approval. You control visibility with the `skills` argument and [backend routing](#backends-and-remote-skill-loading), access with filesystem permissions, and approval with `interrupt_on` or permission rules with `mode="interrupt"`.
...
Code example: [`code/deepagents/backend-readonly-skills.py`](../code/deepagents/backend-readonly-skills.py)
...
Code example: [`code/deepagents/backend-readonly-skills.ts`](../code/deepagents/backend-readonly-skills.ts)
...
**Python**
Code example: [`code/deepagents/skills-approval.py`](../code/deepagents/skills-approval.py)
...
**JavaScript / TypeScript**
Code example: [`code/deepagents/skills-approval.ts`](../code/deepagents/skills-approval.ts)
...
**Python**
Code example: [`code/deepagents/skills-personal-writable.py`](../code/deepagents/skills-personal-writable.py)
...
**JavaScript / TypeScript**
Code example: [`code/deepagents/skills-personal-writable.ts`](../code/deepagents/skills-personal-writable.ts)
...
The agent can _read_ scripts from any backend, but to _execute_ them, the agent needs access to a shell, which only [sandbox backends](../deepagents/sandboxes.md) provide.

[Sandbox backends](../deepagents/sandboxes.md) run in isolated containers. Skill files stored outside the sandbox are not available inside it, which means the agent cannot execute skill scripts or access skill resources unless they are transferred in first. Use custom middleware to handle this transfer:
...
Code example: [`code/deepagents/skills-sandbox.py`](../code/deepagents/skills-sandbox.py)
...
**JavaScript / TypeScript**
Code example: [`code/deepagents/skills-sandbox.ts`](../code/deepagents/skills-sandbox.ts)
...
2. **Validate `SKILL.md` [frontmatter](#frontmatter-fields).** The [`name`](#frontmatter-fields) must match the parent directory name and follow the Agent Skills specification. Use the `skills-ref` validation tool to check formatting.
...
3. **Sync skills into sandboxes.** If you use [sandbox backends](../deepagents/sandboxes.md), skill files outside the container are not available until you copy them in. See [Sandbox scripts](#sandbox-scripts) and syncing skills and memories with custom middleware.

### Scripts fail to run

**Problem**: The agent reads a script but cannot run it.

**Solution**: The agent can read scripts from any backend, but running them requires a [sandbox backend](../deepagents/sandboxes.md). See [Execute code with skills](#execute-code-with-skills).
