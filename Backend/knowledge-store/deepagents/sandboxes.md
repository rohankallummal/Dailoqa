...
product: deepagents
resource: /docs/deepagents/sandboxes
source: /oss/deepagents/sandboxes
tags:
  - deepagents
  - sandboxes
timestamp: 2026-08-13T16:33:13Z
code_examples:
  - ../code/deepagents/deepagents-sandbox-basic.ts
  - ../code/deepagents/sandboxes-basic-tabs.py
  - ../code/deepagents/deepagents-sandbox-basic-langsmith.py
  - ../code/deepagents/deepagents-sandbox-basic-daytona.py
  - ../code/deepagents/deepagents-sandbox-lifecycle-factory-thread.ts
  - ../code/deepagents/deepagents-sandbox-lifecycle-factory-thread.py
  - ../code/deepagents/deepagents-sandbox-lifecycle-factory-assistant.ts
  - ../code/deepagents/deepagents-sandbox-lifecycle-factory-assistant.py
  - ../code/deepagents/deepagents-sandbox-as-tool.py
  - ../code/deepagents/deepagents-sandbox-as-tool.ts
  - ../code/deepagents/deepagents-sandbox-execute-langsmith.py
  - ../code/deepagents/deepagents-sandbox-upload.ts
  - ../code/deepagents/deepagents-sandbox-download.ts
  - ../code/deepagents/deepagents-sandbox-upload-langsmith.py
  - ../code/deepagents/deepagents-sandbox-download-langsmith.py
---
...
**JavaScript / TypeScript**
Code example: [`code/deepagents/deepagents-sandbox-basic.ts`](../code/deepagents/deepagents-sandbox-basic.ts)
...
**Python**
Code example: [`code/deepagents/sandboxes-basic-tabs.py`](../code/deepagents/sandboxes-basic-tabs.py)
...
```
        ...
        Code example: [`code/deepagents/deepagents-sandbox-basic-langsmith.py`](../code/deepagents/deepagents-sandbox-basic-langsmith.py)
...
```
        ...
        Code example: [`code/deepagents/deepagents-sandbox-basic-daytona.py`](../code/deepagents/deepagents-sandbox-basic-daytona.py)
...
**Python**
For provider-specific setup, authentication, and lifecycle details, see sandbox integrations.
...
Don't see your provider? You can implement your own sandbox backend. See Contributing a sandbox integration.

## Lifecycle and scoping

Most applications choose either one sandbox per thread (thread-scoped) or one shared sandbox for every thread on the same assistant (assistant-scoped).
...
For the full lifecycle table, async graph factory notes, TTL behavior, LangGraph Deployment wiring, and client-side examples, see Sandbox lifecycle in Going to production.
...
**JavaScript / TypeScript**
Code example: [`code/deepagents/deepagents-sandbox-lifecycle-factory-thread.ts`](../code/deepagents/deepagents-sandbox-lifecycle-factory-thread.ts)
...
**Python**
Code example: [`code/deepagents/deepagents-sandbox-lifecycle-factory-thread.py`](../code/deepagents/deepagents-sandbox-lifecycle-factory-thread.py)
...
**JavaScript / TypeScript**
Code example: [`code/deepagents/deepagents-sandbox-lifecycle-factory-assistant.ts`](../code/deepagents/deepagents-sandbox-lifecycle-factory-assistant.ts)
...
**Python**
Code example: [`code/deepagents/deepagents-sandbox-lifecycle-factory-assistant.py`](../code/deepagents/deepagents-sandbox-lifecycle-factory-assistant.py)
...
For manual create, execute, and teardown outside a graph factory, see [Basic usage](#basic-usage) and sandbox integrations for provider-specific APIs.
...
Code example: [`code/deepagents/deepagents-sandbox-as-tool.py`](../code/deepagents/deepagents-sandbox-as-tool.py)
...
Code example: [`code/deepagents/deepagents-sandbox-as-tool.ts`](../code/deepagents/deepagents-sandbox-as-tool.ts)
...
**LangSmith**
        Code example: [`code/deepagents/deepagents-sandbox-execute-langsmith.py`](../code/deepagents/deepagents-sandbox-execute-langsmith.py)
...
Code example: [`code/deepagents/deepagents-sandbox-upload.ts`](../code/deepagents/deepagents-sandbox-upload.ts)
...
Code example: [`code/deepagents/deepagents-sandbox-download.ts`](../code/deepagents/deepagents-sandbox-download.ts)
...
**LangSmith**
        ...
        Code example: [`code/deepagents/deepagents-sandbox-upload-langsmith.py`](../code/deepagents/deepagents-sandbox-upload-langsmith.py)
...
**LangSmith**
        Code example: [`code/deepagents/deepagents-sandbox-download-langsmith.py`](../code/deepagents/deepagents-sandbox-download-langsmith.py)
