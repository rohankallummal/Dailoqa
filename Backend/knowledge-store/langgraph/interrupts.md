...
title: Interrupts
product: langgraph
resource: /docs/langgraph/interrupts
...
code_examples:
  - ../code/langgraph/langgraph-interrupts-resume-v2.py
  - ../code/langgraph/langgraph-interrupts-hitl-stream.py
  - ../code/langgraph/langgraph-interrupts-hitl-stream.ts
  - ../code/langgraph/langgraph-interrupts-multiple.py
  - ../code/langgraph/langgraph-interrupts-approval.py
  - ../code/langgraph/langgraph-interrupts-review.py
  - ../code/langgraph/langgraph-interrupts-validate-conditional-edge-pattern.py
  - ../code/langgraph/langgraph-interrupts-validate-conditional-edge-pattern.ts
  - ../code/langgraph/langgraph-interrupts-validate-conditional-edge.py
  - ../code/langgraph/langgraph-interrupts-validate-conditional-edge.ts
---

# Interrupts

Interrupts allow you to pause graph execution at specific points and wait for external input before continuing. This enables human-in-the-loop patterns where you need external input to proceed. When an interrupt is triggered, LangGraph saves the graph state using its [persistence](../langgraph/persistence.md) layer and waits indefinitely until you resume execution.
...
- **Interrupt payloads surface via `stream.interrupts`:** when using event streaming (`graph.stream_events(..., version="v3")`), the values you pass to `interrupt()` appear on `stream.interrupts`, and `stream.interrupted` is `True` when the run pauses for input.
...
Code example: [`code/langgraph/langgraph-interrupts-resume-v2.py`](../code/langgraph/langgraph-interrupts-resume-v2.py)
...
**Python**
Code example: [`code/langgraph/langgraph-interrupts-hitl-stream.py`](../code/langgraph/langgraph-interrupts-hitl-stream.py)
...
**JavaScript / TypeScript**
Code example: [`code/langgraph/langgraph-interrupts-hitl-stream.ts`](../code/langgraph/langgraph-interrupts-hitl-stream.ts)
...
Code example: [`code/langgraph/langgraph-interrupts-multiple.py`](../code/langgraph/langgraph-interrupts-multiple.py)
...
**Python**
    ...
    Code example: [`code/langgraph/langgraph-interrupts-approval.py`](../code/langgraph/langgraph-interrupts-approval.py)
...
**Python**
    ...
    Code example: [`code/langgraph/langgraph-interrupts-review.py`](../code/langgraph/langgraph-interrupts-review.py)
...
Code example: [`code/langgraph/langgraph-interrupts-validate-conditional-edge-pattern.py`](../code/langgraph/langgraph-interrupts-validate-conditional-edge-pattern.py)
...
Code example: [`code/langgraph/langgraph-interrupts-validate-conditional-edge-pattern.ts`](../code/langgraph/langgraph-interrupts-validate-conditional-edge-pattern.ts)
...
**Python**
    ...
    Code example: [`code/langgraph/langgraph-interrupts-validate-conditional-edge.py`](../code/langgraph/langgraph-interrupts-validate-conditional-edge.py)
...
**JavaScript / TypeScript**
    ...
    Code example: [`code/langgraph/langgraph-interrupts-validate-conditional-edge.ts`](../code/langgraph/langgraph-interrupts-validate-conditional-edge.ts)
